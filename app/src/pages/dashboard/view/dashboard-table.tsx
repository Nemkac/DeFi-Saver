...
const DashboardTableSection = () => {
    ...
    return (
        <motion.div
            className='flex flex-col w-full gap-10 max-w-6xl'
            variants={container}
        ...
        >
            <div className='flex flex-col md:flex-row md:justify-between w-full gap-4 md:gap-10'>
                <motion.h3
                    className='text-h3 text-on-surface-primary font-bold'
                    variants={item}
                >
                ...
                <motion.div variants={item}>
                    <Link to='/cdp-positions'>
                        <div className='group flex flex-row px-6 py-2 items-center justify-center gap-4 border rounded-md border-indicator-primary bg-feedback-primary hover:bg-indicator-primary transition-[0.5s]'>
                            <p className='text-p-md text-on-surface-primary'>Search CDP Positions</p>
