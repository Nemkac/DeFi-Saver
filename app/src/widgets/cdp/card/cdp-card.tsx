    ...
    return (
        <div className="flex flex-col w-full max-w-[100vw] gap-3 p-4 rounded-xl border border-border bg-elevated">
            ...
            <button
                ...
                className="flex items-center justify-center gap-1 text-p-sm text-secondary hover:text-primary transition-colors"
            >
                <div className='flex flex-row gap-2 items-center'>
                    <p className='text-p-xs text-secondary'>{expanded ? 'Show less' : 'Show more'}</p>
